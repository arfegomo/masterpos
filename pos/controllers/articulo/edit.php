...
$Articulo->set_idarticulo($_GET["idarticulo"]);
$articulos = $Articulo->load();
...
$clasificacion2 = $Clasificacion2->listado_clasificacion2();
 ...
 Twig_Autoloader::register();
	...
	$template = $twig->loadTemplate('articulo/edit_articulo.twig.php');

	echo $template->render(array('tablas' => $tablas,'articulos' => $articulos, 'clasificacion1' => $clasificacion1, 'clasificacion2' => $clasificacion2,'rol' => $_SESSION["rol"]));
