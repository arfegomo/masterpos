                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <?php 
                            foreach ($tablas as $tabla) { ?>
                                <li>
                                <a href="<?php echo $tabla["tabla"] ?>"><i class="fa fa-table fa-fw"></i> <?php echo utf8_encode($tabla["nombretabla"]) ?> </a>
                                </li>
                            <?php } ?>                        
                        <li>
                            <a href=""><i class="fa fa-dashboard fa-fw"></i> Cerrar sesión</a>
                        </li>
                   </ul>
                </div>
                <!-- /.sidebar-collapse -->
