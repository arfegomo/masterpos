...
/* ciudad/list_ciudad.twig.php */
class __TwigTemplate_8adaf15afc21390d05a93221b3df4490 extends Twig_Template
{
    protected $parent;
...
\t<div align=\"right\"><a href=\"create.php\" class=\"btn btn-primary btn-xs\">Crear ciudad</a></div>
...
\t\t          <td>";
            // line 91
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'ciudad'), "nombreciudad", array(), "any", false), "html");
            echo "</td>
...
";
    ...
    {
        return "ciudad/list_ciudad.twig.php";
    }
