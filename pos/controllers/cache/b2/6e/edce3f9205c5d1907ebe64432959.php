...
/* caja/list_caja.twig.php */
class __TwigTemplate_b26eedce3f9205c5d1907ebe64432959 extends Twig_Template
{
    protected $parent;
...
\t<div align=\"right\"><a href=\"create.php\" class=\"btn btn-primary btn-xs\">Crear caja</a></div>
...
\t        ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, 'cajas'));
...
\t\t          <td>";
            // line 92
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'caja'), "idcaja", array(), "any", false), "html");
            echo "</td>
...
";
    ...
    {
        return "caja/list_caja.twig.php";
    }
