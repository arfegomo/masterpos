...
/* departamento/list_departamento.twig.php */
class __TwigTemplate_97bdd59a0ce513bfaed79e30d421819c extends Twig_Template
{
    protected $parent;
...
\t        ";
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['departamentos']) {
            // line 88
            echo "
\t\t\t\t<tr>
...
\t\t          <td>";
            // line 93
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'departamentos'), "nombredepartamento", array(), "any", false), "html");
            echo "</td>
...
\t\t\t";
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['departamentos'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "departamento/list_departamento.twig.php";
    }
