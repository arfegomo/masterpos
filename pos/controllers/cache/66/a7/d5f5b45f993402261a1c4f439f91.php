...
/* clasificacion2/list_clasificacion2.twig.php */
class __TwigTemplate_66a7d5f5b45f993402261a1c4f439f91 extends Twig_Template
{
    protected $parent;
...
\t\t\t\t<h1 class=\"page-header\">Clasificaciones 2</h1>
...
\t<div align=\"right\"><a href=\"create.php\" class=\"btn btn-primary btn-xs\">Crear clasificacion 2</a></div>
...
\t\t          <td>";
            // line 92
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'clasificacion'), "nombreclasificacion2", array(), "any", false), "html");
            echo "</td>
...
";
    ...
    {
        return "clasificacion2/list_clasificacion2.twig.php";
    }
