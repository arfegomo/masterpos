...
{% block contenido %}
	...
	<div class="row">
		...
		<div class="col-lg-12">
				...
				<h1 class="page-header">Tipos de documento</h1>
	...
	<div align="right"><a href="create.php" class="btn btn-primary btn-xs">Crear tipo documento</a></div>
	...
	<div class="table-responsive">
		...
		<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
	      ...
	      <tbody>
	        ...
	        {% for tipodocumento in tipodocumento %}
